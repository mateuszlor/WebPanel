            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator runat="server" ValidationGroup="Validation" ErrorMessage="Pole jest wymagane" ControlToValidate="NewName" CssClass="alert-danger" />
                    </td>
                </tr>
                <tr>
                    <th>Ilość: </th>
                    <td>
                        ...
                        <asp:RequiredFieldValidator runat="server" ValidationGroup="Validation" ErrorMessage="Pole jest wymagane" ControlToValidate="NewRepeats" CssClass="alert-danger" />
                    </td>
                </tr>
            </tbody>
        </table>
